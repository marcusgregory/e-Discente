...
class NotificationAwesome {
    ...
    AwesomeNotifications().initialize(
        ...
        [
          ...
          NotificationChannel(
              ...
              channelDescription: 'Atualizações das Turmas',
              channelShowBadge: true,
              enableVibration: true,
              defaultPrivacy: NotificationPrivacy.Public,
              importance: NotificationImportance.Max,
  ...
  static void createBasicNotification(String title, String body) async {
    await AwesomeNotifications().createNotification(
        content: NotificationContent(
            id: title.hashCode,
            channelKey: "basic_channel",
  ...
  static void createNotificationNewNoticia(
  ...
  static void createNotificationTarefa(String title, String body) async {
    await AwesomeNotifications().createNotification(
        content: NotificationContent(
      id: body.hashCode,
      channelKey: "tasks_channel",
  ...
  static void createNotificationAtualizacaoTurma(
